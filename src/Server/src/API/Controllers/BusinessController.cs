...
{
    public class
        BusinessController : BaseController<Business, BusinessViewModel, BusinessBaseQueryModel, IBusinessService>
    {
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<FeedbackViewModel>> GiveFeedback(
            [FromBody] InsertFeedbackToBusinessQueryModel model)
        {

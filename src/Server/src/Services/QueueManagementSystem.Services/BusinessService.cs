...
namespace QueueManagementSystem.Services
{
    public class BusinessService : BaseService<Business, BusinessViewModel, BusinessBaseQueryModel>, IBusinessService
    {
        ...
        public BusinessService(IUnitOfWork unitOfWork, IBusinessRepository repository,
        ...
        {
            var business =
                await Repository.GetFirstOrDefaultAsync(predicate: b => b.Id == businessId, disableTracking: false);

...
namespace QueueManagementSystem.Infrastructure.Persistence.Database
{
    ...
    {
        public QueueManagementSystemContext(DbContextOptions<QueueManagementSystemContext> dbContextOptions) : base(dbContextOptions)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            string connectionString = configuration["ConnectionStrings:SchoolConnection"];
            if (extension != null)
